...
Изменения в версии 7.46 - 7.47
- добавлен расчет сепарации газа на приеме ЭЦН для ПКВ 
- поправлен расчет электрических параметров ЭЦН 

Изменения в версии 7.45
- расширена функциональность расчета струйных аппаратов
- расширена функциональность расчета коэффициентов сепарации газа

Изменения в версии 7.42
- добавлены кнопки для вставки примеров генерации json строк для ЭЦН
- исправлены ошибки для функций газлифтных клапанов

Изменения в версии 7.41
- добавлены кнопки для вставки примеров генерации json строк для IPR и трубы

Изменения в версии 7.40
- возвращена возможность расчета простых PVT параметров без json строки (чтобы удобнее было показывать первый раз)
- возвращена возможность в некоторых расчетах указывать дебит, обводненность как параметры непосредственно
- небольшая переработка интерфейса вызова некоторых функций

Изменения в версии 7.39
- поправлен расчет калибровки на вязкость. теперь она соответствует заявленой калибровке при пластовой температуре 
- небольшой рефакторинг в расчете pvt (не должно влиять на результат) 

Изменения к версии 7.38
- добавлен вариант расчета скважины - (давления и температуры)


Изменения к версии 7.36
- добавлен вариант расчета струйного насоса

Изменения к версии 7.35
- добавлены функции слияния и разделения потоков флюидов 
- добавлен сниппет с конвертером единиц
- поправлен ряд разных багов
- добавлены функции расчета неустановившегося забойного давления при старте скважины (transient)
