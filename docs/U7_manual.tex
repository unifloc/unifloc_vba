...
\addlegendentry{$T = 140$ \textdegree С}
\end{axis}
\end{tikzpicture}
...
\addlegendentry{$T = 20$  \textdegree С}
\addplot table [y=T_0_60, x=P]{\zDataFile};
\addlegendentry{$T = 60$  \textdegree С}
\addplot table [y=T_0_100, x=P]{\zDataFile};
\addlegendentry{$T = 100$  \textdegree С}
